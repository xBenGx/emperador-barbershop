      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            animate="visible"
            exit="exit"
            className="fixed inset-0 z-[90] bg-[#050505]/98 flex flex-col justify-center items-center lg:hidden overflow-y-auto"
          >
            ...
            <div className="flex flex-col items-center space-y-8 w-full px-8 relative z-10 py-20">
              {/* Rutas de Navegación */}
