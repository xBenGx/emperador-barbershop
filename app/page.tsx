...
// NUEVO: DATA PARA EL HERO CAROUSEL
const HERO_BANNERS = [
  {
    id: 1,
    title1: "TRUE",
  ...
  },
  {
    ...
    title1: "LAST",
    title2: "CALL!",
    subtitle: "Por la compra del Combo Emperador VIP, lleva un perfilado de cejas totalmente GRATIS.",
...
// ============================================================================
// VISTA PRINCIPAL (Landing Page Urbana & Premium + E-commerce)
// ============================================================================
...
export default function UltimateEmperadorLanding() {
  ...
  const [currentSlide, setCurrentSlide] = useState(0); // ESTADO DEL HERO SLIDER
  ...
  return (
    <main className="bg-[#050505] min-h-screen font-sans selection:bg-amber-500 selection:text-black overflow-x-hidden relative">
      ...
      {/* GLOBAL BACKGROUND - MANTIENE TU RUIDO Y LUCES */}
      ...
      {/* 1. NAVBAR PREMIUM CON LOGO GIGANTE, LOGIN Y AHORA CARRITO */}
      ...
      {/* 2. HERO HYPE SECTION EVOLUCIONADO (CARRUSEL AL ESTILO MACONLINE) */}
      <section className="relative h-[100svh] flex items-center justify-center overflow-hidden bg-black">
        <AnimatePresence mode="wait">
          ...
          >
            <Image 
              src={HERO_BANNERS[currentSlide].bgImg} 
        ...
        <div className="relative z-10 w-full max-w-[1400px] px-6 text-center mt-24">
          ...
          {/* Indicadores del Slider en la base del Hero */}
          <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex gap-3 z-20">
            {HERO_BANNERS.map((_, idx) => (
              <button 
                key={idx} onClick={() => setCurrentSlide(idx)}
                className={`h-2 rounded-full transition-all duration-500 ${currentSlide === idx ? "w-12 bg-amber-500" : "w-4 bg-zinc-700 hover:bg-zinc-500"}`}
              />
            ))}
          </div>
        </div>
      ...
      {/* 3. NUEVA SECCIÓN: LA TIENDA (ARSENAL) */}
      <section id="tienda" className="py-32 bg-zinc-950 border-y border-zinc-900 relative">
        <div className="max-w-[1400px] mx-auto px-6">
                ...
                <motion.div key={product.id} variants={popUp} className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden group hover:border-amber-500 transition-colors shadow-2xl flex flex-col relative">
                   ...
                   <div className="relative aspect-square overflow-hidden bg-zinc-800/30 p-8 flex items-center justify-center">
                      ...
                      <div className="relative w-[90%] h-[90%]">
                        <Image src={product.img} fill alt={product.name} className="object-contain group-hover:scale-110 transition-transform duration-700 drop-shadow-[0_20px_30px_rgba(0,0,0,0.5)]" />
                      </div>
                   </div>
          ...
          <div className="mt-16 text-center">
             <button className="px-10 py-4 border border-zinc-700 text-zinc-300 font-bold text-xs uppercase tracking-widest rounded-xl hover:border-amber-500 hover:text-amber-500 transition-colors flex items-center gap-3 mx-auto">
